...
export const HeaderBtn = ({ name }) => {
  ...
  return (
    <Link to={addnewProduct && "/account/addproduct"}>
      <div className="hover:bg-[#87878b] hover:text-black hover:bg-opacity-5 cursor-pointer px-2 py-1 rounded text-[0.84rem] flex-row items-center justify-center gap-[0.14rem] ">
        <span>
